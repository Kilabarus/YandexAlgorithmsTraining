...
namespace YandexTraining
{
    internal class Program
    {
        ...
        {
            (int N, int startStation, int endStation, _, _, _, _, _) = GetTupleOfInt32Args(input[0]);
            ...
            return endStation - startStation - 1 < startStation - 1 + N - endStation
                ? $"{endStation - startStation - 1}"
                : $"{startStation - 1 + N - endStation}";
        }
